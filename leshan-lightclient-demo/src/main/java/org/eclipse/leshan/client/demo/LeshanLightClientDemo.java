...
public class LeshanLightClientDemo {

    private static final Logger LOG = LoggerFactory.getLogger(LeshanLightClientDemo.class);

    private final static String[] modelPaths = new String[] { "3303.xml", "3311.xml" };

    private static final int OBJECT_ID_TEMPERATURE_SENSOR = 3303;
    private static final int OBJECT_ID_LIGHT_CONTROLLER = 3311;
    private final static String DEFAULT_ENDPOINT = "LeshanLightClientDemo";
    private final static String USAGE = "java -jar leshan-lightclient-demo.jar [OPTION]\n\n";
	...
	initializer.setInstancesForObject(OBJECT_ID_LIGHT_CONTROLLER, new LightController());
